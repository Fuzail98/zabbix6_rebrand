...
/*		(isset($ZBX_SERVER_NAME) && $ZBX_SERVER_NAME !== '')
			...
			: null,*/
			(new CDiv([
                                (new CLabel("Sign in to your ICCN activeSONOR"))
                                        ]))->addCLass(ZBX_STYLE_SERVER_NAME),
                         (new CDiv([
                                 (new CLabel("Network Monitoring Account"))
                                           ]))->addCLass(ZBX_STYLE_SERVER_NAME),
		(new CDiv([
		...
		(new CDiv([
			"Don't have an account?&nbsp",
                        (new CLink('Sign up', 'https://www.activesonor.com'))
